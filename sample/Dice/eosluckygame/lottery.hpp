...
namespace eoswin {
    ...
    // #define TOKEN_ACCOUNT N(eoslucktoken)
    ...
    #define STATUS_ID_CLAIM_PEROID_BASE_TIME 104           //分红池累积开始的基准时间(1539651600 秒) UTC: 2018/10/16 01:00:00
    #define STATUS_ID_CLAIM_PEROID_ACC_INTERVAL 105        //分红池累积持续时间
    #define STATUS_ID_CLAIM_PEROID_CLAIM_INTERVAL 106      //分红池领取持续时间
    ...
    struct global_item {
        ...
        uint8_t  token_bonus;                       // %: bonus for token
        uint8_t  team_fee;                          // %: fee for team
        uint8_t  drawer_fee;                        // %: fee for drawer
        asset    drawer_fee_max;
        uint8_t  mine_probability;                  // %: probability for mine token
	...
	class lottery : public eosio::contract {
		public:
            ...
            // deal with eosio.token transfer message
            ...
            /*
             * example: erasehistory(2, 2) => erase data of 2,3 round
            */
